...
type
  ...
  private
    ...
    procedure ControlarBotoes (btnNovo, btnAlterar,
          btnCancelar, btnGravar, btnApagar:TBitBtn; Navegador:TDBNavigator;
          pgcPrincipal: TPageControl; Flag:Boolean);
    procedure ControlarIndiTab(pgcPrincipal: TPageControl; Indice: Integer);
...
procedure TfrmTelaHeranca.ControlarIndiTab (pgcPrincipal: TPageControl;
          Indice: Integer);
begin
...
begin
  try
    if (Apagar) then begin
      ...
      ControlarIndiTab (pgcPrincipal, 0);
      LimparEdits;
      QryListagem.Refresh;
    end
      else begin
